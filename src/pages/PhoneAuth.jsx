            ...
            <>
              ...
              <form onSubmit={handlePhoneSubmit}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium text-white transition-colors disabled:opacity-50"
              ...
              <form onSubmit={handleVerifySubmit}>
                <div className="mb-6">
                  ...
                  <input
                    ...
                    maxLength={4}
                    className="w-full px-4 py-3 bg-background-secondary border-0 text-sm text-text-primary placeholder:text-text-secondary focus:outline-none transition-colors text-center text-2xl tracking-widest font-mono"
                    autoFocus
                  />
                </div>
                {error && <p className="text-xs text-red-500 mb-4">{error}</p>}
