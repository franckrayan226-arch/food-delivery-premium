  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-32">
        <div className="mb-4 flex flex-col sm:flex-row sm:items-start gap-6">
          <img
            src={restaurant.logo}
            alt={restaurant.name}
        ...
        <div className="mb-4">
          <input
            ...
            className="w-full px-4 py-3 bg-background-secondary border-0 text-sm text-text-primary placeholder:text-text-secondary focus:outline-none transition-colors truncate"
          />
        </div>
      ...
      {getTotalItems() > 0 && (
        <div className="fixed bottom-24 right-6 z-50">
          <button
            ...
            className="px-5 py-3 bg-accent-primary text-white flex items-center gap-3 text-sm font-medium hover:bg-accent-secondary transition-colors"
...
const MenuItemCard = ({ item, onAddToCart, restaurantColor }) => {
  ...
  return (
    <div className="flex gap-4 py-5 border-b border-border-light">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium border border-border-light text-text-secondary hover:border-accent-primary hover:text-accent-primary transition-colors"
