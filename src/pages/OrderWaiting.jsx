        ...
        <div className="space-y-3">
          {canConfirmReceipt && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 text-white transition-colors"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-border-light text-text-secondary hover:border-accent-primary hover:text-accent-primary transition-colors"
          >
